        ...
        players.append(
            {
                ...
                "fieldGoalsMade": round_stat(row["FGM"], "FGM"),
                "fieldGoalAttempts": round_stat(row["FGA"], "FGA"),
                "threePointersMade": round_stat(row["FG3M"], "FG3M"),
                "freeThrowAttempts": round_stat(row["FTA"], "FTA"),
        ...
        players.append(
            {
                ...
                "minutes": None,
                "fieldGoalsMade": None,
                "fieldGoalAttempts": None,
                "threePointersMade": None,
                "freeThrowAttempts": None,
                "points": None,
                "rebounds": None,
                "assists": None,
                "steals": None,
